...
namespace Rhino.ServiceBus
{
    public static class Extensions
    {
        ...
        {
            configuration.ConfigurationStarted += ()=>
                new DefaultRegistration(container, configuration);
            return configuration;
        }

        private class DefaultRegistration
        {
            public DefaultRegistration(IWindsorContainer container, AbstractRhinoServiceBusFacility configuration)
            {
                ...
                container.Register(
                    AllTypes.FromAssembly(typeof (DefaultRegistration).Assembly)
